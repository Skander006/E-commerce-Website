                ...
                <div className="p-6 flex-2">
                    <nav className="rounded-xl shadow-lg flex justify-around items-center gap-16 p-6">
                        ...
                        <NavLink to="/dashboard"
                                 onClick={()=>setOpen2("")}
                                 className={({isActive}) => isActive ? "font-bold underline text-black text-2xl" : "text-xl font-medium text-gray-800 hover:scale-102 transition-all duration-300"}>Dashboard</NavLink>
                    </nav>
